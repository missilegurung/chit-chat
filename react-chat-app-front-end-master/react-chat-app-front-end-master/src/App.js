...
function App() {
  ...
  const sendMessage = (e) => {
    ...
    setMessage("");
    // missile, suraj [missile-suraj] => [m1, m2, m3], suraj-missile
    // missile, tanveer [missile-tanveer] => [m1, m2, m3]
    //suraj, tanveer [suraj-tanveer] => [m1, m2, m3]
  };
  ...
  return (
    <div className="App">
      <header className="app-header">
        <img src={logo} alt="" />
        <div className="app-name b-500 primaryColor">Chit Chat</div>
      </header>
